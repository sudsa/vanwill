...
/**
 * Created by zouhw02 on 2021/7/22.
 */
public class AlgGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/sys?characterEncoding=utf8");
        ...
        strategy.setInclude(new String[] { "sys_config" }); // 需要生成的表
